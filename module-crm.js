  ...
  function _injectNav() {
    ...
    section.innerHTML =
      ...
      '<div class="nav-item" id="nav-crm-clients" onclick="crmGo(\'clients\',this)" data-view="clients">' +
        '<svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg> Clients' +
      '</div>' +
      '<div class="nav-item" id="nav-crm-leads" onclick="crmGo(\'leads\',this)" data-view="leads">' +
        '<svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg> Leads Pipeline' +
      '</div>';
